...
/**
 * HTTP client for firing workflow notifications from document-service.
 * Called after a document is successfully uploaded or verified.
...
public class NotificationClient {
    ...
    /**
     * Sends only an IN_APP notification (used when email is not available).
     */
